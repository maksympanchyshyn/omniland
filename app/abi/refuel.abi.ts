export const BUNGEE_REFUEL_ABI = [
  { inputs: [], stateMutability: 'nonpayable', type: 'constructor' },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'destinationReceiver', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
      { indexed: false, internalType: 'bytes32', name: 'srcChainTxHash', type: 'bytes32' },
    ],
    name: 'Send',
    type: 'event',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes32[]', name: 'srcChainTxHashes', type: 'bytes32[]' },
